...
OUT = Path("/home/user/workspace/sophi-market-map/data_14mkt.js")

with open(SRC / "accounts_v3_14mkt.json") as f:
    data = json.load(f)
...
MARKET_CENTERS = {
    ...
    "ft_lauderdale": [-80.1373, 26.1224],
}

MARKET_CAP = {
    "charlotte": 0.50, "indianapolis": 0.50, "phoenix": 0.30,
    "denver": 0.30, "cleveland": 0.30, "louisville": 0.30,
    "ft_wayne": 0.30, "cincinnati": 0.30, "columbus": 0.30,
    "minneapolis": 0.30, "st_louis": 0.30, "raleigh": 0.30,
    "charleston": 0.30, "ft_lauderdale": 0.30,
}
