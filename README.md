# SOPHI Mobility — Advisor Working File

Interactive working file for SOPHI Mobility's 2026 capital strategy, used to finalize deal terms with a new CFO and business advisor before either round goes live. Hosted at [joshuapcasey.github.io/sophi-deal-room](https://joshuapcasey.github.io/sophi-deal-room/).
...
- **TAM:** $150.35M across six markets
- **SAM:** $57.27M (93 in-SAM accounts of 203 named)
- **Y5 SOM:** $28.29M (34 accounts won, 36.6% SAM penetration)
- **5-year cumulative:** $75.52M parking + $21.3M SMS ad layer = $96.8M total

### Per-market Y5

| Market | Cap | In-SAM | Won Y5 | 5-yr SOM | Y5 SOM |
|---|---|---|---|---|---|
...
## Returns · both rounds against same exit scenarios

Exit at end of 2031. R1 = 5-yr hold from Jan 2027 close. R2 = 4-yr hold from early 2028 close.
...
14 screens across 4 groups:

- **Overview** — Summary, Capital Strategy (two-round plan), Company History
- **The opportunity** — SOPHI OS (Hub · Staffing · Revenue), Growth Model (six-market map, drilldown)
- **The deal** — Use of Funds (R1 + R2), Cash Model, Financial Performance, Valuation (downside · base · upside), Competition, Risk Mitigating Milestones
- **Advisor working file** — Advisor Questions (9 open decisions), Methodology, Documents (14 artifacts)

Plus a 12-slide advisor working deck PDF as an instant-download in the Documents tab.
...
Joshua Casey · Founder & CEO · SOPHI Mobility LLC
[jcasey@sophimobility.com](mailto:jcasey@sophimobility.com) · Indianapolis, IN

*Advisor working file — pre-final terms. Not for redistribution.*
